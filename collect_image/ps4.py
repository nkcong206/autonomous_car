...
class MyPS4Controller(Controller,Node):
    def __init__(self, **kwargs):
        Controller.__init__(self, **kwargs)
        Node.__init__(self, 'my_controller_node')
        self.junction = False
...
def main():
    rclpy.init()
    ps4_controller_node = MyPS4Controller(interface="/dev/input/js0", connecting_using_ds4drv=False).listen()
